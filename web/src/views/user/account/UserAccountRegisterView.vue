      ...
      <div class="col-3">
        <form @submit.prevent="register">
          ...
          <div class="mb-3">
            ...
            <input v-model="confirmedPwd" type="password" class="form-control" id="confirmedPwd" placeholder="请再次输入密码">
          </div>
...
export default {
  ...
  setup(){
    ...
    const register=()=>{
      $.ajax({
        url:'https://app5801.acapp.acwing.com.cn/api/user/account/register/',
        type:'post',
        data:{
